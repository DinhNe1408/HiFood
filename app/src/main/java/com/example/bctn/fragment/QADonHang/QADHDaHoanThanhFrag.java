...
public class QADHDaHoanThanhFrag extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setRecV() {
        List<donhang> donhangList = MyAppication.mDao.ListQADH(MyAppication.mTaiKhoan.getIDQA(), key.key_dh_HoanThanh);
