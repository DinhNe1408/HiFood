...
public class QuanTri extends AppCompatActivity {
    ...
    private void setData() {
        ...
        menu_optionList.add(new menu_option(key.key_QLTaiKhoan,"Quản lý tài khoản"));
        menu_optionList.add(new menu_option(key.key_QLQuanAn,"Quản lý quán ăn"));
        menu_optionList.add(new menu_option(key.key_QLDonHang,"Quản lý đơn hàng"));
        menu_optionList.add(new menu_option(key.key_ThongKe,"Thống kê"));
